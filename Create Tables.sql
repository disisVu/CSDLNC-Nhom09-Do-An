IF DB_ID ('QL_PhongKhamNhaKhoa') IS NOT NULL
...
(   
    NS_ID int NOT NULL,
	NS_HoTen varchar(30) NOT NULL,
	NS_GioiTinh varchar(5) NOT NULL,
...
(
	...
	LH_NhanVienDatHen int NOT NULL,
	LH_KhamChinh int NOT NULL,
	LH_TroKham int,
...
(
	KHDT_ID int NOT NULL,
	KHDT_TrangThai varchar(20),
	KHDT_KhamChinh int NOT NULL,
	KHDT_TroKham int,
	HSBN_ID int NOT NULL,
	LT_ID int,
...
(
	DIEUTRI_ID int NOT NULL,
	THUOC_ID int NOT NULL,
	DONTHUOC_SoLuongThuoc int NOT NULL,
	DONTHUOC_TongGia float NOT NULL,
...
ADD
	CONSTRAINT FK_KEHOACHDIEUTRI_KHAMCHINH
	FOREIGN KEY (KHDT_KhamChinh)
	REFERENCES NHA_SI(NS_ID)

ALTER TABLE KE_HOACH_DIEU_TRI
ADD
	CONSTRAINT FK_KEHOACHDIEUTRI_TROKHAM
	FOREIGN KEY (KHDT_TroKham)
	REFERENCES NHA_SI(NS_ID)
...
ADD
	CONSTRAINT FK_RANGDIEUTRI_LIEUTRINH
	FOREIGN KEY (LT_ID)
	REFERENCES LIEU_TRINH(LT_ID)
